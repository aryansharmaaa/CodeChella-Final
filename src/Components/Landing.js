...
const Landing = () => {
  ...
  return (
    <>
      ...
      <div className="h-4 w-full bg-gradient-to-r from-blue-500 via-purple-500 to-dark-500">
        <center><h2 id="header"> <img class = "hello" src="https://res.cloudinary.com/duycnul2b/image/upload/v1686233010/Codechella_kho1e9.png"></img></h2></center>
      </div>
